...
<body class="bg-gray-100 font-sans">
    ...
    <main class="container mx-auto px-4 py-6">
        ...
        @else
            <div class="bg-white rounded-lg shadow-md p-4 mb-6">
                <p class="text-gray-600">برای ثبت نظر، <a href="{{ route('login') }}" class="text-blue-600">وارد شوید</a>.</p>
            </div>
        @endauth
                ...
                @foreach ($menuItems as $menuItem)
                    <div class="bg-white rounded-lg shadow-md overflow-hidden">
                        ...
                        <div class="p-4">
                            ...
                            <button @click="addToCart({{ $menuItem->id }})" class="mt-2 bg-blue-600 text-white px-4 py-2 rounded-lg">افزودن به سبد</button>
                        </div>
                    </div>
                @endforeach
            </div>
